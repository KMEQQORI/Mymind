...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\CategoriesController' => __DIR__.'/getCategoriesControllerService.php',
            'App\\Controller\\CommentsController' => __DIR__.'/getCommentsControllerService.php',
            'App\\Controller\\GoalsController' => __DIR__.'/getGoalsControllerService.php',
            'App\\Controller\\TachesController' => __DIR__.'/getTachesControllerService.php',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addRuntimeLoader(new \Twig\RuntimeLoader\ContainerRuntimeLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('JMS\\Serializer\\Twig\\SerializerRuntimeHelper' => function () {
            return ($this->services['jms_serializer.twig_extension.serializer_runtime_helper'] ?? $this->load(__DIR__.'/getJmsSerializer_TwigExtension_SerializerRuntimeHelperService.php'));
