...
// Returns the private 'App\Repository\NotesPageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NotesPageRepository.php';

return $this->privates['App\Repository\NotesPageRepository'] = new \App\Repository\NotesPageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
