...
$a->setNamespace('sf_orm_default_46833a0aea650c7a8ea9d4707ba5f42cbcab21e65d80eab8852f4ecdef548d98');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_46833a0aea650c7a8ea9d4707ba5f42cbcab21e65d80eab8852f4ecdef548d98');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_46833a0aea650c7a8ea9d4707ba5f42cbcab21e65d80eab8852f4ecdef548d98');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategorieRepository' => function () {
    ...
    return ($this->privates['App\Repository\GoalRepository'] ?? $this->load(__DIR__.'/getGoalRepositoryService.php'));
}, 'App\\Repository\\TacheRepository' => function () {
    return ($this->privates['App\Repository\TacheRepository'] ?? $this->load(__DIR__.'/getTacheRepositoryService.php'));
}))));
