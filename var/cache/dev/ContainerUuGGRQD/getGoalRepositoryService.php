...
// Returns the private 'App\Repository\GoalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GoalRepository.php';

return $this->privates['App\Repository\GoalRepository'] = new \App\Repository\GoalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
